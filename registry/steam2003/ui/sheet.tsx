  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          "fixed z-50 flex flex-col bevel-out bg-panel",
      ...
      >
        ...
        {showCloseButton && (
          <SheetPrimitive.Close asChild>
            <Button
              size="icon"
              className="absolute top-1 right-1.5 !size-[14px] [&_svg]:size-3"
              aria-label="Close"
            >
              <XIcon />
            </Button>
...
function SheetFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("flex justify-end gap-2 p-3 pt-0", className)}
      {...props}
    />
  )
}
